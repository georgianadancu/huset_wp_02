...
function getSearchData(){
  ...
  fetch("http://georgianadancu.com/wordpress/wp-json/wp/v2/categories?_embed&search="+search)
    .then(res=>res.json())
    .then(handleData)
}

function getFrontpageData(){
  fetch("http://georgianadancu.com/wordpress/wp-json/wp/v2/categories?_embed")
    .then(res=>res.json())
    .then(handleData)
}
...
function getCategoryData(catId){
  console.log(catId)
  fetch("http://georgianadancu.com/wordpress/wp-json/wp/v2/categories?_embed&categories="+catId)
    .then(res=>res.json())
    .then(handleData)
}
...
function getSinglePost(){
  ...
  fetch("http://georgianadancu.com/wordpress/wp-json/wp/v2/categories/photography"+id)
    .then(res=>res.json())
  .then(showPost)
